      ...
      <div className="min-h-screen bg-gradient-to-tr  justify-center items-center">
        <div className="md:px-4">
          <div className="max-w-sm bg-white px-6 shadow-xl pt-6 pb-2 rounded-xl  transform hover:scale-105 transition duration-500">
            ...
            <h1 className="mt-4 text-gray-800 text-base font-bold font-inter cursor-pointer">
              Category : {subcategory_Name}
            </h1>
            <h1 className="mt-4 text-gray-800 text-base  font-inter cursor-pointer">
              {descriptions}
            </h1>
            <div className="my-4">
              ...
              <div className="flex space-x-1 items-center">
                <span>
                  <BsStopwatch className="h-6 w-6 text-indigo-600 mb-1.5"></BsStopwatch>
                </span>
                <p>{processingTime}</p>
              </div>
              <div className="flex space-x-1 items-center">
